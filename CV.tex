...
\begin{document}
    ...
    \begin{longtable}{@{\extracolsep{\fill}}c c c c@{}}
        \begin{tabular}{@{\hspace{0mm}}c@{\hspace{1mm}}c@{\hspace{3mm}}cl}
            ...
            2019 & & &\\
            \vspace*{-8mm}\\
            & & & $\bullet$ Contractor for electrical engineering and software development.\\
            \vspace*{-2mm}\\
            %No Generics
            ...
            & & & \color{maroon}{\rule{14cm}{0.75pt}}\\
            %Fake-JNI
            Jan & \multirow{2}{*}{-} & \multirow{2}{*}{present} & \textbf{\href{https://github.com/meme/fake-jni/tree/rewrite}{fake-jni}} - C++, CMake, JNI, JVMTI\\
            2019 & & &\\
            \vspace*{-8.5mm}\\
        ...
        \begin{tabular}{@{\hspace{0mm}}c@{\hspace{1mm}}c@{\hspace{3mm}}cl}
            ...
            \multicolumn{3}{c}{} & \texttt{Systemd; Init; Cron; iproute2; iptables}\\[-1mm]
            \vspace{-0.75mm}\\
...
%            \multicolumn{3}{c}{January 21, 2019} & \textbf{Woburn Challenge Online Round 3}\\
            \multicolumn{3}{c}{December 7, 2018} & \textbf{15th Windsor Regional Secondary School Programming Competition}\\
%            \multicolumn{3}{c}{November 29, 2018} & \textbf{Woburn Challenge Online Round 2}\\
%            \multicolumn{3}{c}{October 29, 2018} & \textbf{Woburn Challenge Online Round 1}\\
